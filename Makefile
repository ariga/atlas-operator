...
# atlasgo.io/atlas-operator-bundle:$VERSION and atlasgo.io/atlas-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= atlasgo.io/atlas-operator
...
.PHONY: kind
kind: $(KIND) ## Download kind locally if necessary. If wrong version is installed, it will be removed before downloading.
$(KIND): $(LOCALBIN)
