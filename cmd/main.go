...
// therefore reconciled. This makes it possible to run multiple operator
// instances side by side, each owning a distinct set of resources. Referenced
// ConfigMaps and Secrets are intentionally left unfiltered by label, since
// they usually do not carry the operator's labels.
