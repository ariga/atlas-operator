...
func (in *AtlasDriftCheckList) DeepCopyInto(out *AtlasDriftCheckList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]AtlasDriftCheck, len(*in))
		for i := range *in {
