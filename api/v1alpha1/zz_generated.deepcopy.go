...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DirFrom) DeepCopyInto(out *DirFrom) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DirFrom.
func (in *DirFrom) DeepCopy() *DirFrom {
	if in == nil {
		return nil
	}
	out := new(DirFrom)
