...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomDevDB) DeepCopyInto(out *CustomDevDB) {
	*out = *in
	in.Spec.DeepCopyInto(&out.Spec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomDevDB.
func (in *CustomDevDB) DeepCopy() *CustomDevDB {
	if in == nil {
		return nil
	}
	out := new(CustomDevDB)
