...
If you want use use any feature that require login (Trigger, Functions, Procedure, and Sequence support or SQL Server, ClickHouse, Redshift drivers), you need to provide an Atlas token to the operator. You can do this by creating a secret with the token:
